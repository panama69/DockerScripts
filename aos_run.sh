...
-e "POSTGRES_IP=nimbusserver.aos.com" \
-e "MAIN_PORT=8000" \
-e "ACCOUNT_PORT=8001" \
-e 'MAIN_IP=nimbusserver.aos.com' \
-e "ACCOUNT_IP=nimbusserver.aos.com" \
-e "PGPASSWORD=admin" \
-e "AGENT_NAME=aos-accountservice-dev" \
